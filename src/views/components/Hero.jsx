...
export default function Hero() {
    return (
        <section className="hero">
            <img src="/public/Yureka-Assets/librarian-owl.png" alt="librarian-owl" className="librarian-owl" />
            <div className="hero-content">
                <h1 className="typing">Welcome to</h1>
                <img src="/public/Yureka-Assets/yureka-m-logo.png" alt="Logo" className="logo-hero-y"/>
