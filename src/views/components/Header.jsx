        ...
        <header className="main-header">
            <div className="header-content">
                ...
                <nav className="main-nav desktop-nav">
                    <Link to="/adventure">
                        <img src="/public/Yureka-Assets/adventure-nav.png" alt="adventure" className="adventure-nav" />
                    </Link>
                    <Link to="/discover">
                        <img src="/public/Yureka-Assets/discover-nav.png" alt="discover" className="discover-nav" />
                    </Link>
                    <Link to="/flashcards">
                ...
                <div className="profile-container">
                    <img
                        src="/public/Yureka-Assets/profile-icon.png"
                        alt="profile-icon"
